...
function AddNewSong(props) {
    ...
    return (
        <form onSubmit={addNewSong} className="w-full text-center">
            ...
            <input onChange={event => {setNewSongURL(event.target.value)}} className="shadow appearance-none border rounded w-1/5 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-3" id="username" type="text" placeholder="URL (Youtube, SoundCloud)"></input>
